                    ...
                    <div className="bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 sm:p-6 shadow-sm dark:shadow-xl space-y-5 transition-colors">
                        <div className="flex items-center gap-2.5 pb-3 border-b border-slate-200 dark:border-slate-800/80">
                            ...
                            <div>
                                ...
                                <p className="text-[11px] text-slate-500 dark:text-slate-400">Configure sewing lines or non-sewing machine line capacities by department.</p>
                            </div>
                        </div>
                        ...
                        <div className="pt-2 border-t border-slate-200 dark:border-slate-800">
                            <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-2 text-xs">
                                Factory Capabilities & Compliance Badges
                            </label>
                            ...
                            <div className="flex items-center gap-2 mt-3">
                                <input
                                    ...
                                    placeholder="Add custom certification or capability tag..."
                                    className="text-xs bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 rounded-xl px-3 py-2 flex-1 focus:outline-none focus:border-blue-500"
                                    onKeyDown={e => {
                                        if (e.key === 'Enter') {
                                            e.preventDefault();
                                            addCustomCapability();
                        ...
                        {/* Verification & Rating */}
                        <div className="pt-2 border-t border-slate-200 dark:border-slate-800 grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                            <div>
                                <label className="block text-slate-700 dark:text-slate-300 font-semibold mb-1">
                                    Factory Rating (1.00 - 5.00)
                                </label>
                                <input
                                    type="number"
                                    step="0.1"
