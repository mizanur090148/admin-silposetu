        ...
        <AdminLayout title="Factories Management">
            ...
            <div className="space-y-5">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div>
                        <h1 className="text-xl font-black text-slate-900 dark:text-white">Factories Directory</h1>
                        <p className="text-xs text-slate-500 dark:text-slate-400">
                            Comprehensive directory of verified, active, suspended, and registered manufacturing facilities.
                        </p>
                    </div>
